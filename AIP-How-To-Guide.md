...
Steps
    ...
    5. When it finishes running, cd /the/location/you/specified/for/the/output/Files. There you will see a number of folders and files. These are the files AIP uses to remember past runs. Go to the directory /Historical_Ratings/ to see the output blacklists.
      -
The Input Data
...
./Run-AIP
Your blacklists will be in the /AIP/Historical_Ratings/ directory.
Useful Information
