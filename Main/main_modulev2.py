...
def rate_IPs_all_time_normalized(list_of_flows, time_of_newest_data_file):
        ...
        for flow in list_of_flows:
            ...
            average_events_score = (((average_events - min_av_event) / (max_av_event - min_av_event)) * average_event_weight)
            duration_score = ((duration - min_dur) / (max_dur - min_dur)) * total_duration_weight
            average_duration_score = (((average_duration - min_av_dur) / (max_av_dur - min_av_dur)) * average_duration_weight)
            ...
            average_packets_score = (((average_packets - min_av_packet) / (max_av_packet - min_av_packet)) * average_packet_weight)
